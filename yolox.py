...
from utils.utils import (cvtColor, get_classes, preprocess_input, resize_image,
                         show_config)
from utils.utils_bbox_yolox import decode_outputs, non_max_suppression


class YOLOX(object):
    _defaults = {
      
        "model_path"        : 'model_data/yolox_weights.pth',
    ...
    def detect_image(self, image, crop = False, count = False):
        ...
        font        = ImageFont.truetype(font='model_data/simhei.ttf', size=np.floor(3e-2 * image.size[1]*0.4 + 0.5).astype('int32'))
