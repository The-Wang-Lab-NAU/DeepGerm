...
from utils.utils import (cvtColor, get_classes, preprocess_input, resize_image,
                         show_config)
from utils.utils_bbox_centerNet import decode_bbox, postprocess


class CenterNet(object):
    _defaults = {
       
        "model_path"        : r'model_data\centernet_weights.pth',
    ...
    def detect_image(self, image, crop = False, count = False):
        ...
        font = ImageFont.truetype(font='model_data/simhei.ttf', size=np.floor(3e-2 * np.shape(image)[1]*0.25 + 0.5).astype('int32'))
