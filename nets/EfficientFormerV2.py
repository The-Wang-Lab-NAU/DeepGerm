...
def efficientformerv2_s0(pretrained = False, input_shape = [640, 640], **kwargs):
    ...
    model = EfficientFormerV2(
        ...
        **kwargs)
    if pretrained:
        weights=r"F:\project\yolov5-pytorch-main\model_data\eformer_s0_450.pth"
...
#     model = efficientformerv2_s0(pretrained = False, input_shape = [640, 640])
#     res = model(inputs)
#     for i in res:
#         print(i.size())
